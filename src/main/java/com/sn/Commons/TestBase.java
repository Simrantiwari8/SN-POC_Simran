...
public class TestBase {
	...
	public TestBase(){
		try {
			p=new Properties();
			FileInputStream f=new FileInputStream("C:\\Users\\GT\\Desktop\\AFT ServiceNow Project\\SN-POC\\src\\main\\java\\com\\sn\\Properties\\Config.properties" );
			p.load(f);
			;
		} catch (IOException e) {
	...
	public static void takeScreenshotAtEndOfTest() throws IOException {
		...
		String currentDir = System.getProperty("C:\\Users\\GT\\Desktop\\AFT ServiceNow Project\\SN-POC");
